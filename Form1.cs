...
namespace Isocline
{
    public partial class Form1 : KryptonForm
    {
        ...
        public Form1()
        {
            ...
            //Controller
            graphController = new GraphController(picture);
        ...
        {
            picture.Image = new Bitmap(picture.Width, picture.Height, picture.CreateGraphics());
            bool showLine = kryptonCheckBox2.Checked;
            bool showBar = kryptonCheckBox3.Checked;
            bool showScatter = kryptonCheckBox1.Checked;
            bool showIsocline = kryptonCheckBox4.Checked;
            {
                if (showLine)
                {
                    graphView.PrintGraph(null, null);
                ...
                if (showBar)
                {
                    graphView.PrintGraph2(null, null);
                }
                ...
                if (showIsocline)
                {
                    isoclineView.ShowIsoClines(null, null);
                } 
